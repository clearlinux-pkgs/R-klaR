...
Version  : 0.6.13
Release  : 1
URL      : https://cran.r-project.org/src/contrib/klaR_0.6-13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/klaR_0.6-13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521301760
