...
Version  : 1.7.2
Release  : 56
URL      : https://cran.r-project.org/src/contrib/klaR_1.7-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/klaR_1.7-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679330312
