...
Version  : 0.6.15
Release  : 45
URL      : https://cran.r-project.org/src/contrib/klaR_0.6-15.tar.gz
Source0  : https://cran.r-project.org/src/contrib/klaR_0.6-15.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589784152
